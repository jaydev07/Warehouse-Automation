...
#importing msgRosIot from pkg_ros_iot_bridge package
...
#creating class of Action Server
class IotRosBridgeActionServer:
    ...
    def __init__(self):
        ...
        self._config_mqtt_sub_cb_ros_topic = param_config_iot['sub_cb_ros_topic']
        self._config_google_spread_sheet_id=param_config_iot['googleapps']['spread_sheet_id']
    ...
    def process_goal(self, goal_handle):
        ...
        if(goal.protocol == "mqtt"):
            ...
            if(goal.mode == "pub"):
                ...
                rospy.logwarn(goal.topic + " > " + goal.turtle_x + "," + goal.turtle_y + "," + goal.turtle_theta)

                ret = iot.mqtt_publish( self._config_mqtt_server_url, 
                                        self._config_mqtt_server_port,
                                        goal.topic, 
                                        str("("+goal.turtle_x+","+goal.turtle_y+","+goal.turtle_theta+")"), 
                                        self._config_mqtt_qos   )
		
		# Sending the data to our Google Sheet
        	parameters = {"id":"Sheet1","turtle_x":goal.turtle_x, "turtle_y":goal.turtle_y, "turtle_theta":goal.turtle_theta}
		URL = "https://script.google.com/macros/s/AKfycbwMIdEZP5HySgpaMvmA8jy5gcdFWxQIPQApq1MuuoTRL1t600w/exec"
